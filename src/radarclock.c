...
PBL_APP_INFO(MY_UUID,
             "Radar Minimal", "squaresine-ModOf 8a22a/Elzor",
             1, 1, /* App version */
...
void handle_init(AppContextRef app_ctx) {
  ...
  window_init(&window, "Radar Minimal");
  ...
  rotbmp_pair_layer_set_src_ic(&hour_hand_image_container.layer, GPoint(50, 55));
  ...
  text_layer_init(&day_layer, GRect(34, 145, 28, 12)); 
  ...
  text_layer_init(&date_layer, GRect(63, 145, 21, 12));
  ...
  text_layer_init(&month_layer, GRect(84, 145, 28, 12));
